...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    result = max(2 * (score // 10) - score % 10, 1)
    return result
    # END PROBLEM 2
...
def is_swap(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4
    player_last_two_digits = player_score % 100
    opponent_last_two_digits = opponent_score % 100
    player_difference = abs(player_last_two_digits // 10 - player_last_two_digits % 10)
    opponent_difference = abs(opponent_last_two_digits // 10 - opponent_last_two_digits % 10)
    return player_difference == opponent_difference
    # END PROBLEM 4
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        if (delta > previous_high):
            print(delta, "point(s)! That's the biggest gain yet for " + player)
        return announce_highest(who, max(previous_high, delta), score)
    return say
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    """
    # BEGIN PROBLEM 9
    test_roll = make_averaged(roll_dice, num_samples)
    index = 0
    result = 0
    best_dice = 1
    while (index < 10):
        if (result < test_roll(index + 1, dice)):
            best_dice = index + 1
            result = test_roll(index + 1, dice)
        index += 1
    return best_dice
    # END PROBLEM 9
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    # BEGIN PROBLEM 11
    bacon_score = free_bacon(opponent_score)
    potential_score = score + bacon_score
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    first_strategy = swap_strategy(score, opponent_score, 4, 5)
    if (not first_strategy == 0 and (100 - score) <= 10):
        return (100 - score) // 2
